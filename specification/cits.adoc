...
According to https://public.ccsds.org/Pubs/651x0m1.pdf[PAIMAS] ( Producer-Archive Interface Methodology Abstract Standard) a Submission Agreement should include a complete and precise definition of:
